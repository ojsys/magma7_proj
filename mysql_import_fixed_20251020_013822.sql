-- =====================================================
-- Magma7 Fitness - MySQL Import File (Fixed)
-- Generated: 2025-10-20 01:38:22
...
CREATE TABLE `memberships_planfeature` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `cms_sitesettings` (
  ...
  `hero_cta_text` VARCHAR(50) NOT NULL,
  `hero_cta_url` VARCHAR(200) NOT NULL,
  `hero_image_url` VARCHAR(200) NOT NULL,
  `primary_color` VARCHAR(7) NOT NULL,
  `accent_color` VARCHAR(7) NOT NULL,
  `light_color` VARCHAR(7) NOT NULL,
  `dark_bg` VARCHAR(7) NOT NULL,
  `card_bg` VARCHAR(7) NOT NULL,
  `free_guide_description` TEXT NOT NULL,
  `free_guide_text` VARCHAR(50) NOT NULL,
  `free_guide_title` VARCHAR(100) NOT NULL,
  `free_guide_url` VARCHAR(200) NOT NULL,
  `cta_description` TEXT NOT NULL,
  `cta_headline` VARCHAR(200) NOT NULL,
  `cta_image_url` VARCHAR(200) NOT NULL,
  `cta_primary_text` VARCHAR(50) NOT NULL,
  `cta_primary_url` VARCHAR(200) NOT NULL,
  `cta_secondary_text` VARCHAR(50) NOT NULL,
  `cta_secondary_url` VARCHAR(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `cms_aboutgalleryimage` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `cms_aboutstatistic` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `cms_whychooseusitem` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `title` VARCHAR(150) NOT NULL,
  `description` TEXT NOT NULL,
  `icon` VARCHAR(50) NOT NULL,
...
CREATE TABLE `cms_facilitiespage` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `hero_title` VARCHAR(200) NOT NULL,
  `hero_subtitle` TEXT NOT NULL,
  `hero_image_url` VARCHAR(200) NOT NULL,
...
CREATE TABLE `memberships_workoutlog` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `memberships_workoutsession` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
  `title` VARCHAR(200) NOT NULL,
  `workout_type` VARCHAR(20) NOT NULL,
...
CREATE TABLE `memberships_weeklygoal` (
  `id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
